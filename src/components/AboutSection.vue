  ...
  <section class="text-white mt-18" id="about">
        ...
        <div class="md:grid md:grid-cols-2 gap-8 items-center py-8 px-4 xl:gap-16 sm:py-16 xl:px-16 z-1">
            ...
            <div class="mt-4 md:mt-0 text-left flex flex-col z-10 h-full" data-aos="flip-right">
                ...
                <p class="text-base lg:text-lg mt-8 py-8">Sono uno sviluppatore full-stack con esperienza nella creazione di applicazioni scalabili e moderne. Con una forte competenza in JavaScript e TypeScript, lavoro su progetti sia frontend che backend, garantendo soluzioni efficienti, di alta qualità e un'esperienza utente eccellente. La mia passione per la programmazione mi spinge ad esplorare sempre nuove tecnologie per migliorare costantemente il mio lavoro.
                </p>
                <!--  <div class="grid grid-cols-3 gap-4 max-w-lg pt-8">
                    <div class="text-center rounded-xl bg-[#111a3e] shadow-lg border border-[#1f1641] p-3">
                        ...
                        <p class="text-sm sm:text-base text-gray-300">Clienti Soddisfatti</p>
                    </div>
                    <div class="text-center rounded-xl bg-[#111a3e] shadow-lg border border-[#1f1641] p-3">
                        <h3 class="text-white font-bold text-xl sm:text-2xl lg:text-3xl">+14</h3>
                        <p class="text-sm sm:text-base text-gray-300">Progetti</p>
                    </div>
                    <div class="text-center rounded-xl bg-[#111a3e] shadow-lg border border-[#1f1641] p-3">
                        <h3 class="text-white font-bold text-xl sm:text-2xl lg:text-3xl">+1</h3>
                        <p class="text-sm sm:text-base text-gray-300"> Anno di Esperienza</p>
                    </div>
                </div>      -->
...
const education = ref([
    {
        ...
        program: 'Diploma in Applied Science',
        year: '2020'
    },
    {
        id:2,
        school:'Digitazon Tech School',
        program: 'Sviluppatore Full Stack',
        year: '2024'
    }
])
</script>
